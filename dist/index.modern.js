import React__default, { useState, createElement, Fragment, useEffect } from 'react';
...
function FBRadioButton(props) {
  ...
  var _useState = useState("radio-" + Math.floor(Math.random() * 1000000)),
      id = _useState[0];
...
function generateElementComponentsFromSchemas(parameters) {
  ...
  var elementList = elementPropArr.map(function (elementProp, index) {
    ...
    if (elementProp.propType === 'card') {
      ...
      return /*#__PURE__*/createElement("div", null, /*#__PURE__*/createElement("h2", null, " Error parsing element "));
    }
  });
  return elementList;
}
...
function DependencyWarning(_ref) {
  ...
  var _useState = useState(getRandomId()),
...
function CardEnumOptions(_ref) {
  ...
  var _loop = function _loop(index) {
    ...
    possibleValues.push( /*#__PURE__*/createElement("div", {
      key: index,
  ...
  return /*#__PURE__*/createElement(Fragment, null, possibleValues, /*#__PURE__*/createElement(FontAwesomeIcon, {
    icon: faPlus,
    onClick: function onClick() {
...
function CardModal(_ref) {
  ...
  var _React$useState = useState(componentProps),
  ...
  return /*#__PURE__*/createElement(Modal, {
  ...
  }, /*#__PURE__*/createElement(ModalHeader, {
    className: "card-modal-header"
  }, /*#__PURE__*/createElement("div", {
    style: {
      display: componentProps.hideKey ? 'none' : 'initial'
    }
  }, /*#__PURE__*/createElement("h3", null, "Additional Settings"))), /*#__PURE__*/createElement(ModalBody, {
    className: "card-modal-entries"
  }, /*#__PURE__*/createElement(TypeSpecificParameters, {
    parameters: componentPropsState,
    onChange: function onChange(newState) {
      setComponentProps(_extends({}, componentPropsState, newState));
    }
  }), /*#__PURE__*/createElement("div", null, /*#__PURE__*/createElement("h4", null, "Column Size", ' ', /*#__PURE__*/createElement("a", {
    ...
    className: "card-modal-text"
  })), /*#__PURE__*/createElement(DependencyField, {
    parameters: componentPropsState,
    onChange: function onChange(newState) {
      setComponentProps(_extends({}, componentPropsState, newState));
    }
  })), /*#__PURE__*/createElement(ModalFooter, null, /*#__PURE__*/createElement(Button, {
    onClick: function onClick() {
      onClose();
...
function GeneralParameterInputs(_ref) {
  ...
  return /*#__PURE__*/createElement("div", null, /*#__PURE__*/createElement(CardBody, {
    parameters: parameters,
    onChange: onChange,
    mods: mods || {}
  }));
...
function Add(_ref) {
  ...
  var _useState2 = useState('card'),
      createChoice = _useState2[0],
      setCreateChoice = _useState2[1];

  var _useState3 = useState(getRandomId()),
  ...
  }, "Create new form element"), /*#__PURE__*/React__default.createElement(Popover, {
    placement: "bottom",
    target: elementId + "_add",
    isOpen: popoverOpen,
...
function Card(_ref) {
  ...
  var _React$useState2 = useState(getRandomId()),
      elementId = _React$useState2[0];

  return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement(Collapse, {
    isOpen: cardOpen,
    toggleCollapse: function toggleCollapse() {
      return setCardOpen(!cardOpen);
    },
    title: /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement("span", {
      onClick: function onClick() {
        return setCardOpen(!cardOpen);
      },
      className: "label"
    }, componentProps.title || componentProps.name, ' ', componentProps.parent ? /*#__PURE__*/createElement(Example, {
      text: "Depends on " + componentProps.parent,
      id: elementId + "_parentinfo",
      type: "alert"
    }) : '', componentProps.$ref !== undefined ? /*#__PURE__*/createElement(Example, {
    ...
    })), /*#__PURE__*/createElement(UncontrolledTooltip, {
      placement: "top",
      target: elementId + "_moveupbiginfo"
    }, "Move form element up"), /*#__PURE__*/createElement("span", {
  ...
  }, /*#__PURE__*/createElement(CardGeneralParameterInputs, {
  ...
  }, "Additional configurations for this form element"), /*#__PURE__*/createElement("span", {
  ...
  }, "Delete form element"), /*#__PURE__*/createElement(FBCheckbox, {
    onChangeValue: function onChangeValue() {
  ...
  })), /*#__PURE__*/createElement(CardModal, {
    ...
    TypeSpecificParameters: TypeSpecificParameters
  })), _addElem ? /*#__PURE__*/createElement(Add, {
    addElem: function addElem(choice) {
...
var getInputCardBodyComponent = function getInputCardBodyComponent(_ref2) {
  ...
  return function InputCardBodyComponent(_ref3) {
    ...
    return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement("h5", null, "Default value"), /*#__PURE__*/createElement(Input, {
...
function MultipleChoice(_ref5) {
  ...
  var _React$useState = useState(!!enumArray.length && !containsString),
  ...
  return /*#__PURE__*/createElement("div", {
    className: "card-enum"
  }, /*#__PURE__*/createElement("h3", null, "Possible Values"), /*#__PURE__*/createElement(FBCheckbox, {
    onChangeValue: function onChangeValue() {
...
function FormBuilder(_ref) {
  ...
  var _React$useState = useState(defaultCollapseStates),
      cardOpenArray = _React$useState[0],
      setCardOpenArray = _React$useState[1];
  ...
  return /*#__PURE__*/createElement("div", {
    ...
    color: "warning"
  }, /*#__PURE__*/createElement("h5", null, "Unsupported Features:"), unsupportedFeatures.map(function (message, index) {
    return /*#__PURE__*/createElement("li", {
      key: index
    }, message);
  })), (!mods || mods.showFormHead !== false) && /*#__PURE__*/createElement("div", {
    className: classes.formHead,
    "data-test": "form-head"
  }, /*#__PURE__*/createElement("div", null, /*#__PURE__*/createElement("h5", {
    "data-test": "form-name-label"
  }, mods && mods.labels && typeof mods.labels.formNameLabel === 'string' ? mods.labels.formNameLabel : 'Form Name'), /*#__PURE__*/createElement(Input, {
    value: schemaData.title || '',
    placeholder: "Title",
    type: "text",
    onChange: function onChange(ev) {
  ...
  }, mods && mods.labels && typeof mods.labels.formDescriptionLabel === 'string' ? mods.labels.formDescriptionLabel : 'Form Description'), /*#__PURE__*/createElement(Input, {
    value: schemaData.description || '',
    placeholder: "Description",
    type: "text",
    onChange: function onChange(ev) {
  ...
  }, /*#__PURE__*/createElement(DragDropContext, {
    onDragEnd: function onDragEnd$1(result) {
      return onDragEnd(result, {
        schema: schemaData,
